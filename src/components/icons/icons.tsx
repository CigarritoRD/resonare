...
export const BarChart2Icon = ({ className }: { className: string }) => {
	return (
		<svg
			aria-hidden="true"
			width={24}
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			className={`${className} icon icon-tabler icons-tabler-outline icon-tabler-bar-chart-2`}
		>
			<path stroke="none" d="M0 0h24v24H0z" fill="none" />
...
export const UserPlusIcon = ({ className }: { className: string }) => {
	return (
		<svg
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			className={`${className} icon icon-tabler icons-tabler-outline icon-tabler-user-plus`}
		>
			<path stroke="none" d="M0 0h24v24H0z" fill="none" />
			<path d="M20 18v-4a3 3 0 0 0-3-3h-4a3 3 0 0 0-3 3v4" />
...
export const UserMinusIcon = ({ className }: { className: string }) => {
	return (
		<svg
			...
			strokeLinecap="round"
			strokeLinejoin="round"
			className={`${className} icon icon-tabler icons-tabler-outline icon-tabler-user-minus`}
		>
			<path stroke="none" d="M0 0h24v24H0z" fill="none" />
